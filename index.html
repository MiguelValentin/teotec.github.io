...
<head>
    ...
    <meta name="keyword"
          content="agency, business, corporate, creative, modern, responsive, simple"/>

    <!--  Title -->
    <title>Teotec | Expertos que lo hacen posible</title>

    <!-- Font Google -->
    <link href="https://fonts.googleapis.com/css?family=Roboto:100,300,400,500,700,900&display=swap" rel="stylesheet">
    <!-- <link href="assets/fonts/helvetica.otf" rel="stylesheet"> -->
...
<div class="preloader">
    ...
    <h1 class="title v-middle">
        ...
        <span class="text-strok">TEOTEC</span>
        <span class="text-fill">TEOTEC</span>
    </h1>
        ...
        <div class="inner-header p-relative">
            <div class="main-logo">
                <a href="index.html" data-dsn="parallax">
                    <img class="dark-logo" src="assets/img/logo-dark.svg" alt=""/>
            ...
            <ul class="extend-container p-relative d-flex flex-column justify-content-center h-100">
                ...
                <li class="dsn-drop-down">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="about.html">
                                <span class="dsn-title-menu">Sobre Nosotros</span>
                                <span class="dsn-meta-menu">01</span>
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="about-2.html">
                                <span class="dsn-title-menu">Sobre Nosotros V2</span>
                                <span class="dsn-meta-menu">02</span>
                            </a>
                        </li>
            ...
            <div class="container-content  d-flex flex-column justify-content-end">
                <div class="nav__info">
                    ...
                    <div class="nav-content">
                        ...
                        <p class="links  over-hidden">
                            <a href="#" data-hover-text="contacto@teotec.pe" class="link-hover">contacto@teotec.pe</a>
                        </p>
                    </div>
        ...
        <div class="main-slider demo-2 p-relative w-100 h-100-v over-hidden " data-dsn-header="parallax">
                    ...
                    <div class="swiper-wrapper">
                        <div class="slide-item swiper-slide">
                            <div class="image-bg cover-bg w-100 h-100 "
                                 data-image-src="assets/img/project/project1/1.jpg"  data-overlay="2">
                            </div>
                            <div class="slide-content p-absolute h-100 w-100 ">
                                    ...
                                    <div class="content p-relative w-100">
                                        ...
                                        <h1 class="title user-no-selection">
                                            <a href="project1.html" class="effect-ajax"
                                               data-dsn-ajax="slider">Expertos que Lo Hacen Posible</a>
                                        </h1>

                                        <div class="sub-text-header d-inline-block user-no-selection">
                                            <h5>Miguel Valentin </h5>
                                        ...
                                        <div class="dsn-button-link mt-30 user-no-selection">
                                            <a href="project1.html"
                                               ...
                                               data-dsn-ajax="slider">
                                                <span class="link-text">Ver Identidad</span>
                                ...
                                <div class="description p-absolute d-flex a-item-center background-section">
                                    <p>“Somos la marca que revaloriza la capacidad técnica
                                        informática en el Perú”</p>
                                </div>
                            </div>
                        ...
                        <div class="slide-item swiper-slide">
                            <div class="image-bg cover-bg w-100 h-100"
                                 data-image-src="assets/img/project/project1/1.svg" data-overlay="0"
                            ...
                            <div class="slide-content p-absolute h-100 w-100 ">
                                <div class="row align-items-center h-100">
                                    <div class="content p-relative w-100">
                                        ...
                                        <h1 class="title user-no-selection">
                                            <a href="project1.html" class="color-white effect-ajax"
                                               data-dsn-ajax="slider">TEOTEC</a>
                                        </h1>
                                ...
                                <div class="description p-absolute d-flex a-item-center background-section">
                                    <p>Series of images used for Under Armour's NFL combine authentic apparel.
                                        Photography</p>
                                </div>
                            </div>
                        ...
                        <!-- <div class="slide-item swiper-slide">
                            <div class="image-bg cover-bg w-100 h-100"
                                 data-image-src="assets/img/project/project2/1.jpg" data-overlay="5"
                            ...
                            <div class="slide-content p-absolute h-100 w-100 ">
                                <div class="row align-items-center h-100">
                                    <div class="content p-relative w-100">
                                        ...
                                        <h1 class="title user-no-selection">
                                            <a href="project2.html" class="color-white effect-ajax"
                                               data-dsn-ajax="slider">Zero
                                                Untitled</a>
                                        </h1>
                        ...
                        <div class="slide-item swiper-slide">
                            <div class="image-bg cover-bg w-100 h-100"
                                 data-image-src="assets/img/project/project5/1.jpg" data-overlay="5"
                            ...
                            <div class="slide-content p-absolute h-100 w-100 ">
                                <div class="row align-items-center h-100">
                                    <div class="content p-relative w-100">
                                        ...
                                        <h1 class="title user-no-selection">
                                            <a href="project5.html" class="color-white effect-ajax"
                                               data-dsn-ajax="slider">Blue Edition</a>
                                        </h1>
                        ...
                        <div class="slide-item swiper-slide">
                            <div class="image-bg cover-bg w-100 h-100"
                                 data-image-src="assets/img/project/project3/1.jpg" data-overlay="6">
                            </div>
                            <div class="slide-content p-absolute h-100 w-100 ">
                                <div class="row align-items-center h-100">
                                    <div class="content p-relative w-100">
                                        ...
                                        <h1 class="title user-no-selection">
                                            <a href="project3.html" class="color-white effect-ajax"
                                               data-dsn-ajax="slider">Black
                                                Apartment</a>
                                        </h1>
                                ...
                                <div class="description p-absolute d-flex a-item-center background-section">
                                    <p>Used softwares: 3ds max, corona
                                        render,quixel mixer and Photoshop Overall lighting HDRI</p>
                                </div>
                            </div>
                        ...
                        <div class="slide-item swiper-slide">
                            <div class="image-bg cover-bg w-100 h-100"
                                 data-image-src="assets/img/project/project4/1.jpg" data-overlay="5">
                            </div>
                            <div class="slide-content p-absolute h-100 w-100 ">
                                <div class="row align-items-center h-100">
                                    <div class="content p-relative w-100">
                                        ...
                                        <h1 class="title user-no-selection">
                                            <a href="project4.html" class="color-white effect-ajax"
                                               data-dsn-ajax="slider">Intentional</a>
                                        </h1>
                                ...
                                <div class="description p-absolute d-flex a-item-center background-section">
                                    <p>Personal conceptual project. Reflecting on my personal style of paint
                                        illustration.</p>
                                </div>
                            </div>
                        ...
                        <div class="slide-item swiper-slide">
                            <div class="cover-bg h-100 w-100 p-absolute hidden"
                                 data-image-src="assets/img/project/project7/1.jpg" data-overlay="7">
                            </div>
                            <div class="image-bg cover-bg w-100 h-100">
                                <div data-dsn="video" data-overlay="6">
                                    <video class="bg-image cover-bg dsn-video"
                                           poster="assets/img/project/project7/1.jpg" autoplay loop muted>
                                        <source src="http://theme.dsngrid.com/video/Equator.mp4" type="video/mp4">
                            ...
                            <div class="slide-content p-absolute h-100 w-100 ">
                                <div class="row align-items-center h-100">
                                    <div class="content p-relative w-100">
                                        ...
                                        <h1 class="title user-no-selection">
                                            <a href="project7.html" class="color-white effect-ajax"
                                               data-dsn-ajax="slider">EQUATOR CGI</a>
                                        </h1>
                        ...
                        <div class="slide-item swiper-slide">
                            <div class="image-bg cover-bg w-100 h-100"
                                 data-image-src="assets/img/project/project8/1.jpg" data-overlay="7"
                            ...
                            <div class="slide-content p-absolute h-100 w-100 ">
                                <div class="row align-items-center h-100">
                                    <div class="content p-relative w-100">
                                        ...
                                        <h1 class="title user-no-selection">
                                            <a href="project8.html" class="color-white effect-ajax"
                                               data-dsn-ajax="slider">NATIVE UNION</a>
                                        </h1>
            ...
            <div class="social-network-box text-center w-100-v">
                <div class="social-network">
                    <ul>
                        <li><a class="link-hover" href="https://www.facebook.com/TecnologiaInformaticaTEO" target="_blank" data-hover-text="facebook">facebook</a></li>
                        <li><a class="link-hover" href="https://www.linkedin.com/company/teotec" target="_blank" data-hover-text="linkedin">linkedin</a></li>
                        <li><a class="link-hover" href="https://www.instagram.com/tecnologia_teo" target="_blank" data-hover-text="instagram">instagram</a></li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="intro-about-info">
                                ...
                                <div class="intro-about-info-bottom">
                                    <h2 class="title-h2 dsn-up">Llevamos ofreciendo nuestros servicios desde 2007.</h2>

                                    <p class="dsn-text">Fundada en 2007, Tecnología Informática TG se consolidó como una 
                                        de las mejores empresas de soporte técnico de equipos informáticos, ahora TEOTEC 
                                        toma las nuevas riendas del sector, heredando sus principios y valores, pero con 
                                        una perspectiva enfocada hacia el futuro.
                                    </p>
                                        ...
                                        <div class="accordion__wrapper">
                                            <div class="accordion__item dsn-up">
                                                <div
                                                    ...
                                                    <h4 class="sm-title-block">Nuestra Visión</h4>
                                                </div>
                                                <div class="accordion__answer active">
                                                    <p>Ser una marca líder en soporte técnico 
                                                        en todo el Perú.</p>
                                                </div>
                                            </div>
                                            <div class="accordion__item dsn-up">
                                                <div
                                                    ...
                                                    <h4 class="sm-title-block">Nuestra Meta</h4>
                                                </div>
                                                <div class="accordion__answer">
                                                    <p>Cubrir las nuevas necesidades técnicas de nuestros clientes.</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="accordion__item dsn-up">
                                                <div
                                                    ...
                                                    <h4 class="sm-title-block">Nuestra Misión</h4>
                                                </div>
                                                <div class="accordion__answer">
                                                    <p>Ayudar
                            ...
                            <div class="box-img p-relative  over-hidden">
                                <div class="bg-section p-absolute w-100 h-100">
                                    <div class="h-100" data-dsn-grid="move-up">
                                        <img class="cover-bg-img has-top-bottom" src="assets/img/about-intro.jpg"
                                             alt="">
                                    </div>
                                </div>
                                ...
                                <div class="exper background-theme p-absolute">
                                    <div class="numb-ex">
                                        <span class="word-text has-animate-number">13</span>
                                    </div>

                                    <h4 class="sm-title-block dsn-up">AÑOS DE <br> EXPERIENCIA PROFESIONAL</h4>
            ...
            <section class="skills-personal  background-section p-relative section-padding section-margin"
                ...
                <div class="skills-inner container p-relative ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="box-text">
                                <h3 class="title-h2 dsn-text">Brindamos Soporte Técnico de Equipos Informaticos
                                </h3>
                                    ...
                                    <div class="accordion__wrapper">
                                        <div class="accordion__item dsn-up">
                                            <div class="accordion__question p-relative">
                                                <h4 class="sm-title-block ">Diagnostico de Problemas Enfocados</h4>
                                            </div>
                                            <div class="accordion__answer active">
                                                <p>Podemos determinar los problemas específicos de los 
                                                    equipos en base a nuestra experiencia almacenada en 
                                                    nuestra base de datos, de esa manera poder derivar al 
                                                    área específica que podrá diagnosticar de manera enfocada 
                                                    aquellos problemas.</p>
                                            </div>
                                        </div>
                                        <div class="accordion__item dsn-up">
                                            <div class="accordion__question p-relative">
                                                <h4 class="sm-title-block">Desarrollo Preventivo y Correctivo</h4>                                            </div>
                                            <div class="accordion__answer">
                                                <p>Las acciones preventivas disminuyen considerablemente los 
                                                    problemas inesperados, nuestra labor es mantener la tranquilidad 
                                                    de nuestros clientes y evitando esos problemas, pero aun así los 
                                                    problemas se pueden presentar de formas accidentadas, es ahí donde 
                                                    entra el desarrollo de acciones correctivas para solucionar esos 
                                                    problemas.</p>
                                            </div>
                                        </div>
                                        <div class="accordion__item dsn-up">
                                            <div class="accordion__question p-relative">
                                                <h4 class="sm-title-block">Soluciones a la Medida</h4>
                                            </div>
                                            <div class="accordion__answer">
                                                <p>Desarrollamos y presentamos soluciones en base al presupuesto 
                                                    de nuestros clientes, personalizamos a medida estas soluciones 
                                                    para personas y empresas.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="skills-wapper">
                                <div class="skills-item">
                                    <h4 class="sm-title-block">Solucion de Problemas</h4>
                                    <div class="bar">
                                                <span class="fill" data-width="97%">
                                ...
                                <div class="skills-item">
                                    <h4 class="sm-title-block">Desarrollo planificado</h4>
                                    <div class="bar">
                                ...
                                <div class="skills-item">
                                    <h4 class="sm-title-block">Escalabilidad de Solución</h4>
                                    <div class="bar">
                                                <span class="fill" data-width="85%">
...
<!-- Portafolio -->
                ...
                <div class="container-fluid">
                    <div class="work-container over-hidden">
                        <div class="slick-slider">
                            <div class="work-item slick-slide p-relative over-hidden">
                                ...
                                <div class="item-info p-absolute">
                                    <a href="project3.html" class="effect-ajax" data-dsn-ajax="work">
                                        ...
                                        <p>
                                            Used softwares: 3ds max, corona
                                            render,quixel mixer and Photoshop
                                            Overall lighting HDRI, corona skylight
                                            and
                                            materials created by megascans & quixel
                                            Mixer.
                                        </p>
                                ...
                                <div class="item-info p-absolute">
                                    <a href="project1.html" data-dsn-grid="move-up" class="effect-ajax"
                                       data-dsn-ajax="work">
                                        ...
                                        <h5 class="cat">TEOTEC</h5>
                                        <h4>Expertos que lo hacen posible</h4>
                                        <p>“Somos la marca que revaloriza la capacidad técnica informática en el Perú”</p>
                                        <span><span>Ver Identidad</span></span>
                                    </a>
                            ...
                            <div class="work-item slick-slide p-relative over-hidden">
                                <div class="img-next-box p-absolute w-100 h-100" data-overlay="7">
                                    <img class="cover-bg-img" src="assets/img/project/project8/1.jpg" alt=""
                                         data-dsn-position="34%">
                                </div>
                                <div class="item-border p-absolute"></div>
                                <div class="item-info p-absolute">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="box-info">
                                ...
                                <div class="vertical-title ">
                                    <h2 class="dsn-text">Soporte técnico</h2>
                                </div>
                                <div class="bg-mask-content dsn-up">
                                    <div class="mask-bg-2 background-section"></div>
                                    <h6 class="dsn-up">Los problemas aparecen cuando menos lo esperas, 
                                        un acontecimiento que está fuera de nuestros planes.</h6>
                                    <p class="dsn-up">TEOTEC busca ayudarte a solucionar esos problemas. Utilizando todas nuestras herramientas y 
                                        conocimientos buscaremos la mejor solución a tu disposición</p>
                                ...
                                <div class="d-inline-block dsn-up">
                                    ...
                                    <a href="#" class="link-custom d-flex a-item-center p-relative">
                                        <span class="link-text">Cargar más</span>
                                        <span class="link-circle p-absolute">
                                                <i class="fas fa-arrow-right"></i>
                                            </span>
                                    </a>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6 dsn-up blog-classic-item">
                            <div class=" blog-item p-relative d-flex align-items-center h-100 w-100">
                                <div class="after-bg p-absolute w-100 h-100 cover-bg"
                                    ...
                                    <img src="assets/img/blog/1.jpg" alt="" class="cover-bg-img">
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6 dsn-up blog-classic-item">
                            <div
                                ...
                                <div class="after-bg p-absolute w-100 h-100 cover-bg"
                                     data-image-src="assets/img/pattern.png">
                                    <img src="assets/img/blog/2.jpg" alt="" class="cover-bg-img">
                                </div>
                                <div class="box-content p-relative">
                                    <div class="box-content-body">
                                        <div class="entry-date">
                        ...
                        <div class="col-md-4 col-sm-6 dsn-up blog-classic-item">
                            <div class=" blog-item p-relative d-flex align-items-center h-100 w-100">
                                <div class="after-bg p-absolute w-100 h-100 cover-bg"
                                     data-image-src="assets/img/pattern.png">
                                    <img src="assets/img/blog/3.jpg" alt="" class="cover-bg-img">
                                </div>
                                <div class="box-content p-relative">
                                    <div class="box-content-body">
                                        <div class="entry-date">
            ...
            <section class="brand-client section-margin">
                <div class="container section-title-2">
                    <h2>Tu satisfacción, <br> nuestra reputación</h2>
        ...
        <section class="next-up next-project p-relative section-padding">
            <div class="bg-section p-absolute w-100 h-100 over-hidden">
                <!-- <div class="h-100 before-z-index" data-dsn-grid="move-up" data-overlay="5"> -->
                    <img class="cover-bg-img has-top-bottom" src="assets/img/bg-2.jpg" alt="">
                <!-- </div> -->
            </div>
                ...
                <div class="row margin-lr-100">
                    <div class="col-lg-6 col-md-7 offset-lg-6 offset-md-5">
                        <!-- <div class="next-up-inner p-relative background-section"> -->
                            <!-- <h2 class="title">We <br> are <br> hiring!</h2> -->
                            <h2 class="title"><br><br></h2>
                            <h2 class="title"><br><br></h2>
                            <h2 class="title"><br><br></h2>
                            <!-- <a href="contact-2.html" class="btn background-theme p-relative effect-ajax"
                               data-dsn="parallax"><span>Contact us</span></a> -->
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 footer-block-inner">
                            <div class="footer-block">
                                ...
                                <div class="textwidget">
                                    <p>Apoyamos convenios que crean oportunidades para el desarrollo de los estudiantes en el Perú.</p>
                                </div>
                                ...
                                <div class="footer-social p-relative">
                                    <ul>
                                        <li class="over-hidden">
                                            <a href="https://www.facebook.com/TecnologiaInformaticaTEO" data-dsn="parallax" target="_blank"
                                               rel="nofollow">Facebook.</a>
                                        </li>
                                        <li class="over-hidden">
                                            <a href="https://www.linkedin.com/company/teotec" data-dsn="parallax" target="_blank"
                                               rel="nofollow">LinkedIn.</a>
                                        </li>

                                        <li class="over-hidden">
                                            <a href="https://www.instagram.com/tecnologia_teo" data-dsn="parallax" target="_blank"
                        ...
                        <div class="col-lg-3 col-md-6 footer-block-inner">
                            <div class="footer-block col-contact">
                                ...
                                <p><strong>T</strong> <span>:</span>(01) 330 3936</p>
                                <p><strong>C</strong> <span>:</span>981 461 610</p>
                                <p class="over-hidden"><strong>E</strong> <span>:</span><a class="link-hover"
                                                                                           data-hover-text="contacto@teotec.pe"
                                                                                           href="#">contacto@teotec.pe</a>
                                </p>
                            </div>
                        </div>
            ...
            <div class="footer-nav">
                <div class="container">
                    <ul>
                        ...
                        <li><a class="link-hover" data-dsn="parallax" href="#">Portfolio</a></li>
                        <li><a class="link-hover" data-dsn="parallax" href="#">About</a></li>
                        <li><a class="link-hover" data-dsn="parallax" href="#">News</a></li>
                        <li><a class="link-hover" data-dsn="parallax" href="#">Contact</a></li>
                    </ul>
                </div>
            </div>
...
<div class="cursor">
    ...
    <div class="cursor-helper">
        <span class="cursor-drag">Arrastrar</span>
